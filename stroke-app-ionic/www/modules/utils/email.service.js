...
function EmailService($http, EmailCacheService, PatientCacheService, DateTimeService) {
    ...
    var _PatientDisplayLabelsAndValues = [
        ...
        { "label": "Reversal Agent Type", "getter": PatientCacheService.getReversalAgentType },
        { "label": "Reversal Agent Date Time", "getter": PatientCacheService.getReversalAgentDateTime, "isDateTime": true },
