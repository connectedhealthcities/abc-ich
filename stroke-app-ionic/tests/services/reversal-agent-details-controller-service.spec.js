...
describe("ReversalAgentDetailsControllerService", function() {
	...
	describe("hideReversalAgentOptionIdarucizumab", function() {

		it("should return false if the anticoagulantName is 'Dabigatran'", function() {

			var anticoagulantName = 'Dabigatran';
			var hasDoacBeenTaken = null;
			var isHide = service.hideReversalAgentOptionIdarucizumab(anticoagulantName, hasDoacBeenTaken);
			expect(isHide).toBe(false);
		});

		it("should return false if hasDoacBeenTaken is false", function() {

			var anticoagulantName = "anything";
			var hasDoacBeenTaken = false;
			var isHide = service.hideReversalAgentOptionIdarucizumab(anticoagulantName, hasDoacBeenTaken);
			expect(isHide).toBe(false);
		});

		it("should return true if the anticoagulantName is not 'Dabigatran' and hasDoacBeenTaken is true", function() {
	...
	describe("hideReversalAgentOptionPCC", function() {

		it("should return false if the anticoagulantName is 'Apixaban'", function() {

			var anticoagulantName = 'Apixaban';
			var hasDoacBeenTaken = null;
			var isHide = service.hideReversalAgentOptionPCC(anticoagulantName, hasDoacBeenTaken);
			expect(isHide).toBe(false);
		});

		it("should return false if the anticoagulantName is 'Rivoroxaban'", function() {

			var anticoagulantName = 'Rivoroxaban';
			var hasDoacBeenTaken = null;
			var isHide = service.hideReversalAgentOptionPCC(anticoagulantName, hasDoacBeenTaken);
			expect(isHide).toBe(false);
		});

		it("should return false if the anticoagulantName is 'Edoxaban'", function() {

			var anticoagulantName = 'Edoxaban';
			var hasDoacBeenTaken = null;
			var isHide = service.hideReversalAgentOptionPCC(anticoagulantName, hasDoacBeenTaken);
			expect(isHide).toBe(false);
		});
		...
		it("should return true if the anticoagulantName is not 'Apixaban', 'Edoxaban', or 'Rivaroxaban' and hasDoacBeenTaken is true", function() {
