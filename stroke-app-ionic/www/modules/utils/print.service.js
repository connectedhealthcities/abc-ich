...
function PrintService(PatientCacheService, DateTimeService, $ionicLoading) {
    ...
    function getPrintData(patient) {
        var patientDisplayLabelsAndValues = [
            ...
            { "label" : "Reversal Agent Administered At External Hospital" , "value" : PatientCacheService.getReversalAgentAdministeredAtExternalHospital() },                      
            { "label" : "Reversal Agent Administered Time Known" , "value" : PatientCacheService.getReversalAgentAdministeredTimeKnown() },                     
            ...
            { "label" : "Reversal Agent Start Date Time" , "value" : PatientCacheService.getReversalAgentStartDateTime(), "isDateTime": true },  
