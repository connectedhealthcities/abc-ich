...
import org.nibhi.strokeapp.web.rest.vm.KeyAndPasswordVM;
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getEmail().toLowerCase(), managedUserVM.getLangKey(), managedUserVM.getHospitalId());
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getHospitalId());
